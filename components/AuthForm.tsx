...
const AuthForm: React.FC<AuthFormProps> = ({ onLogin, onBack, referralRef }) => {
  ...
  useEffect(() => {
      // Carica Client ID per Google (necessario solo per web)
      fetch('/api/config')
          .then(res => res.json())
          .then(data => {
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex flex-col items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 relative overflow-hidden border border-gray-100">
        ...
        {/* SOCIAL LOGIN - Rimosso se ambiente App rilevato */}
        {!isApp && (
            <>
                <div className="mb-6">
                    <button 
                    ...
                    >
                        ...
                        <span className="text-gray-700 font-black uppercase text-xs tracking-wider">
