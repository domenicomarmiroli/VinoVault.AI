          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <FeatureCard 
                ...
                title="Shop Advisor"
                desc="Sei in enoteca o stai per acquistare online? Scansiona la bottiglia oppure inserisci il link per sapere se il vino si adatta alla tua cantina."
        ...
        <div className="bg-stone-50 py-20 border-b border-gray-200">
           <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                 {/* Card Guida 1 */}
                 <div onClick={() => onOpenGuide?.('cantina-digitale')} className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all cursor-pointer group flex flex-col h-full">
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                        ...
                        <div className="mt-auto pt-4 border-t border-gray-50 flex items-center text-wine-700 font-bold text-[10px] uppercase">Leggi la guida <span className="ml-2 transition-transform group-hover:translate-x-1">→</span></div>
                    </div>
                 </div>

                 {/* Card Guida 2 */}
                 <div onClick={() => onOpenGuide?.('sommelier-a-casa')} className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all cursor-pointer group flex flex-col h-full">
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                        ...
                        <div className="mt-auto pt-4 border-t border-gray-50 flex items-center text-amber-600 font-bold text-[10px] uppercase">Leggi la guida <span className="ml-2 transition-transform group-hover:translate-x-1">→</span></div>
                    </div>
                 </div>

                 {/* Card Guida 4 */}
                 <div onClick={() => onOpenGuide?.('acquisti-intelligenti')} className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all cursor-pointer group flex flex-col h-full">
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                        ...
                        <div className="mt-auto pt-4 border-t border-gray-50 flex items-center text-indigo-700 font-bold text-[10px] uppercase">Leggi la guida <span className="ml-2 transition-transform group-hover:translate-x-1">→</span></div>
                    </div>
                 </div>

                 {/* Card Guida 7 (NEW) */}
                 <div onClick={() => onOpenGuide?.('storico-degustazioni')} className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all cursor-pointer group flex flex-col h-full">
                    <div className="h-40 bg-stone-700 flex items-center justify-center relative overflow-hidden shrink-0">
                        <HistoryIcon className="w-20 h-20 text-white/20 absolute -right-4 -bottom-4 transform rotate-12" filled />
                        <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                            <HistoryIcon className="w-10 h-10 text-white" filled />
                        </div>
                    </div>
                    <div className="p-6 flex-1 flex flex-col">
                        <span className="text-[10px] font-bold uppercase tracking-widest text-stone-500 mb-2 block">Memoria</span>
                        <h3 className="text-lg font-serif font-bold text-gray-900 mb-2 group-hover:text-stone-700 transition-colors">Storico & Memorie</h3>
                        <p className="text-gray-500 text-xs leading-relaxed mb-4">Crea un diario immortale di ogni calice stappato.</p>
                        <div className="mt-auto pt-4 border-t border-gray-50 flex items-center text-stone-700 font-bold text-[10px] uppercase">Leggi la guida <span className="ml-2 transition-transform group-hover:translate-x-1">→</span></div>
                    </div>
                 </div>
              </div>
           </div>
