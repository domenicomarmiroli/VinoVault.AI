...
import { ThermometerIcon, BoxIcon, WineIcon, StarIcon, ChartBarIcon, PencilIcon } from '../components/Icons';
import DrinkabilityBadge from '../components/DrinkabilityBadge';
...
const WineDetailModal: React.FC<WineDetailModalProps> = ({ wine, locations, onClose, onConsume, onUpdateWine, onDelete, isPremium }) => {
  ...
  // Inizializza formData quando wine cambia (da null a oggetto)
  useEffect(() => {
    if (wine) {
      setFormData({ ...wine });
      setIsEditing(false);
